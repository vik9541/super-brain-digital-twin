...
class SentimentAnalyzer:
    ...
    def _analyze_tag_sentiment(self, tags: List[str]) -> float:
        ...
        try:
            ...
            logger.debug(
                f"Tag sentiment: {tag_sentiment} (pos={positive_count}, neg={negative_count}, total={total})"
            )
    ...
    async def _analyze_interaction_sentiment(self, contact_id: str) -> float:
        ...
        try:
            ...
            interaction_response = (
                ...
                .gte("synced_at", three_months_ago)
                .execute()
            )
            ...
            logger.debug(
                f"Interaction sentiment: {interaction_sentiment} ({interaction_count} interactions in 90 days)"
            )
