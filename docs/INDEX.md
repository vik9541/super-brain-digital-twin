# Documentation Index - super-brain-digital-twin v5.0

> Complete index of all documentation across the project ecosystem

---

## Architecture (Start Here)

- [MASTER_README.md](./MASTER_README.md) - Main entry point, v5.0 overview
- [STRUCTURE.md](./STRUCTURE.md) - Complete project hierarchy
- [SUPER_BRAIN_v5.0_GLOBAL_EDITION.md](./SUPER_BRAIN_v5.0_GLOBAL_EDITION.md) - Detailed v5.0 specification
- [ARCHITECTURE.md](./ARCHITECTURE.md) - System design
- [MODULES_MANIFEST.md](./MODULES_MANIFEST.md) - All modules list
...
**Last Updated**: 13 December 2025 | **Version**: v5.0 | **Status**: ACTIVE
