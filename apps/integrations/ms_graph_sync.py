...
class MSGraphContactsSync:
    ...
    async def push_contacts(
        self, user_id: str, min_influence_score: float = 0.0, limit: int = 100
    ) -> Dict:
        """
                        ...
                        results["errors"].append(
                            {
                                ...
                                "email": graph_contact.get("emailAddresses", [{}])[0].get(
                                    "address"
                                ),
                                "error": str(e),
                            }
